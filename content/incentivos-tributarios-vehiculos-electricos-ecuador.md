---
titulo: "Incentivos tributarios para vehículos eléctricos e híbridos en Ecuador"
slug: incentivos-tributarios-vehiculos-electricos-ecuador
...
1. **Cambia con la norma vigente.** Los regímenes de exención tienen vigencia y se modifican. Lo que aplicaba el año pasado puede no aplicar hoy.
2. **Depende del origen y del arancel base.** La exención de aranceles aplica "según el caso": no todo vehículo eléctrico importado tiene el mismo arancel de partida.
3. **Depende de la versión.** Una misma placa comercial puede tener versiones con distinta clasificación.
4. **Depende del tipo de trámite.** El efecto no es igual para una importación directa que para una compra a concesionario, ni para una persona natural que para una empresa.
...
1. **Pide el desglose tributario por escrito** al concesionario y que indique qué impuesto se excluye.
2. **Confirma en el SRI** la norma vigente y la lista de documentos para tu caso.
3. **No compres por el incentivo**: compra porque el auto calza con tu uso y tu presupuesto. El incentivo es un bono, no el motivo.
