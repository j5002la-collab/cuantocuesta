---
titulo: "Qué revisar antes de comprar un carro usado en Ecuador (checklist completo)"
slug: que-revisar-comprar-carro-usado-ecuador
categoria: compra
...
1. **Pide la placa y el número de motor por escrito.** Con la placa puedes consultar el avalúo y las deudas antes de moverte.
2. **Consulta gravámenes, multas e infracciones pendientes.** Si el vendedor se niega a dar la placa, la conversación termina ahí.
...
1. **Prueba de ruta de al menos 15 minutos**, con tramo urbano y una subida. Diez minutos en planicie no revelan nada.
2. **Revisión en un taller de tu confianza**, no en el taller del vendedor. Pagar $30-50 por un diagnóstico previo es el mejor seguro que puedes comprar.
3. **Escaneo computarizado de códigos de error** en un taller con escáner. Borrar códigos antes de la venta es común.
4. **Verificación de kilometraje real** contra los registros de mantenimiento y el desgaste del pedal y la palanca.
5. **Prueba a alta velocidad solo si es seguro y legal** para detectar vibración de dirección o de carrocería.
